...
def test_role_default_guard_name(db):
...
def test_role_name_unique(db, role_user):
...
def test_give_permission_to(db, role_user, permission_edit_users):
...
def test_give_permission_idempotent(db, role_user, permission_view_users):
...
def test_give_multiple_permissions(db, role_user, permission_edit_users, permission_delete_users):
...
def test_revoke_permission_to(db, role_user, permission_view_users):
...
def test_revoke_nonexistent_permission(db, role_user, permission_delete_users):
...
def test_has_permission(role_user):
    """Test checking if role has a permission."""
    assert role_user.has_permission('view users') is True
    assert role_user.has_permission('VIEW USERS') is True
    assert role_user.has_permission('delete users') is False

def test_sync_permissions(db, role_user, permission_edit_users, permission_delete_users):
...
def test_sync_permissions_empty_list(db, role_user):
...
def test_role_users_relationship(db, role_user, user):
...
def test_role_multiple_users(db, role_user):
...
def test_role_cascade_delete(db, role_user, user):
...
def test_permission_cascade_delete(db, role_user, permission_view_users):
