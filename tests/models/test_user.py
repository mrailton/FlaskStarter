...
class TestUserModel:
    ...
    def test_user_email_unique(self, db, user):
    ...
    def test_check_password_case_sensitive(self, user):
...
class TestUserRoles:
    ...
    def test_assign_role(self, db, user, role_user):
    ...
    def test_assign_role_idempotent(self, db, user, role_user):
    ...
    def test_assign_multiple_roles(self, db, user, role_user, role_editor):
    ...
    def test_remove_role(self, db, user, role_user):
    ...
    def test_has_role(self, db, user, role_user):
    ...
    def test_has_any_role(self, db, user, role_user):
    ...
    def test_has_any_role_case_insensitive(self, db, user, role_user):
    ...
    def test_has_all_roles(self, db, user, role_user, role_editor):
    ...
    def test_has_all_roles_case_insensitive(self, db, user, role_user, role_editor):
...
class TestUserPermissions:
    ...
    def test_has_permission(self, db, user, role_user, permission_view_users):
    ...
    def test_has_permission_no_roles(self, user):
        """Test that user without roles has no permissions."""
        assert user.has_permission('view users') is False

    def test_has_permission_multiple_roles(self, db, user, role_user, role_editor):
    ...
    def test_has_any_permission(self, db, user, role_user):
    ...
    def test_has_any_permission_case_insensitive(self, db, user, role_user):
    ...
    def test_has_all_permissions(self, db, user, role_editor):
    ...
    def test_has_all_permissions_case_insensitive(self, db, user, role_editor):
    ...
    def test_get_permissions(self, db, user, role_editor, permission_view_users, permission_edit_users):
    ...
    def test_get_permissions_no_duplicates(self, db, user, role_user, role_editor):
...
class TestUserFlaskLogin:
    ...
    def test_user_is_not_anonymous(self, user):
