...
class TestIndex:
    ...
    def test_index_authenticated(self, authenticated_client, db):
    ...
    def test_index_shows_stats_for_authenticated(self, authenticated_client, db, role_user):
...
class TestDashboard:
    ...
    def test_dashboard_shows_user_count(self, authenticated_client, db):
    ...
    def test_dashboard_shows_role_count(self, authenticated_client, db, role_user):
    ...
    def test_dashboard_shows_permission_count(self, authenticated_client, db, permission_view_users):
    ...
    def test_dashboard_empty_database(self, client, db):
...
class TestMainIntegration:
    ...
    def test_unauthenticated_to_authenticated_flow(self, client, user):
    ...
    def test_dashboard_redirect_after_login(self, client, user):
    ...
    def test_multiple_users_dashboard_access(self, client, db):
